...
We ran hierarchical clustering and silhouette analysis on language-specific fastText CC-300 vectors for all nine (language $\times$ domain) combinations. The results (Table~\ref{tab:baseline-a}) are already informative, though they operate on static embeddings rather than contextual attention.
